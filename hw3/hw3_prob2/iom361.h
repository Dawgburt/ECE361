/**
 * iom361.h - Header file for ECE 361 I/O module simulator
 *
 * @file:	iom361.h
 ...
 * @version:1.0
 *
 * This is the header file for the ECE 361 I/O module simulator.  The I/O module
 * simulates a memory-mapped I/O system with a number of "typical" peripheral registers.
 *
 */
