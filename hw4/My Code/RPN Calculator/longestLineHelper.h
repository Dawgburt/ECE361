...
#ifndef _LONGESTLINEHELPER_H // headder file check
#define _LONGESTLINEHELPER_H // headder file check

// define constants
#include <stdio.h>           // include library
#define MAXCOL 60            // define max coloumb width for each line 
#define MINCOL 0             // define min coloumb width for each line
